          ...
          >
            {attachments.map((attachment, index) => (
              <motion.li
                ...
                className="flex items-center gap-1.5 rounded-lg border border-border bg-surface-sunken/50 py-1 pr-1 pl-2 text-xs"
                exit={
                  shouldReduceMotion
                    ? { opacity: 0, transition: { duration: 0 } }
                    : { opacity: 0, scale: 0.9 }
              ...
              >
                ...
                {onRemoveAttachment ? (
                  <button
                    ...
                    className="cursor-pointer rounded-md p-0.5 text-muted-foreground transition-colors hover:bg-surface-sunken hover:text-foreground"
        ...
        <div className="flex min-w-0 items-center gap-1">
          {onAttach ? (
            <button
              ...
              className="cursor-pointer rounded-lg p-2 text-muted-foreground transition-colors hover:bg-surface-sunken hover:text-foreground"
              disabled={disabled}
              onClick={onAttach}
              type="button"
            >
